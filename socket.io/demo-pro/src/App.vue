    ...
    <div class="content">
      ...
      <div>
        <span
          class="画笔选择"
          id="画笔"
          @click="switchBrushes('画笔', 7)"
        ></span>
        <span
          class="画笔选择"
          id="文字"
          @click="switchBrushes('文字', 8)"
        ></span>
      </div>
      <div>
        <span
          class="画笔选择"
          id="空心矩形"
          @click="switchBrushes('空心矩形', 1)"
        ></span>
        <span
          class="画笔选择"
          id="实心矩形"
          @click="switchBrushes('实心矩形', 2)"
        ></span>
      </div>
      <div>
        <span
          class="画笔选择"
          id="空心圆形"
          @click="switchBrushes('空心圆形', 3)"
        ></span>
        <span
          class="画笔选择"
          id="实心圆形"
          @click="switchBrushes('实心圆形', 4)"
        ></span>
      </div>
      <div>
        <span
          class="画笔选择"
          id="直线"
          @click="switchBrushes('直线', 5)"
        ></span>
        <span
          class="画笔选择"
          id="箭头"
          @click="switchBrushes('箭头', 6)"
        ></span>
      </div>
      <div>
      ...
      <div>
        <div>
          <label for="brushSize">
            画笔 <span id="brushSizeValue">{{ lineWidth }}</span>
          </label>
        </div>
        <div>
          <input
      ...
      <div>
        <div>
          <label for="eraserSize">
            橡皮
            <span id="eraserSizeValue">{{ cilpWidth }}</span>
          </label>
        </div>
        <div>
          <input
